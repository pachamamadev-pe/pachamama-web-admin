...
export class CompanyDocumentsDialogComponent implements OnInit {
  ...
  private loadData(): void {
    ...
    this.documentsService.getDocumentTypes('companies').subscribe({
      ...
      error: (err) => {
        console.error(
          ...oo_tx(`3037710898_97_8_97_66_11`, 'Error al cargar tipos de documentos:', err),
        );
  ...
  private loadUploadedDocuments(): void {
    this.documentsService.getEntityDocuments('companies', this.data.company.id).subscribe({
      ...
      error: (err) => {
        console.error(
          ...oo_tx(`3037710898_114_8_114_65_11`, 'Error al cargar documentos subidos:', err),
        );
  ...
  private loadCompliance(): void {
    this.documentsService.getDocumentCompliance('companies', this.data.company.id).subscribe({
      ...
      error: (err) => {
        console.error(...oo_tx(`3037710898_133_8_133_57_11`, 'Error al cargar compliance:', err));
        this.loading.set(false);
      },
    });
  }
  ...
  private uploadDocument(documentTypeId: string, file: File): void {
    ...
    console.log(
      ...oo_oo(`3037710898_210_4_210_71_4`, 'Uploading document with DTO:', dto, 'and file:', file),
    );
    ...
    this.documentsService
      ...
      .subscribe({
        ...
        error: (err) => {
          console.error(...oo_tx(`3037710898_224_10_224_57_11`, 'Error al subir documento:', err));
  ...
  downloadDocument(document: EntityDocument): void {
    ...
    this.azureStorage
      ...
      .subscribe({
        ...
        error: (err) => {
          console.error(
            ...oo_tx(`3037710898_251_10_251_65_11`, 'Error al obtener URL de descarga:', err),
          );
    ...
    dialogRef.afterClosed().subscribe((confirmed) => {
      ...
      this.documentsService
        ...
        .subscribe({
          next: () => {
            ...
            this.azureStorage.deleteFiles([document.blobName!]).subscribe({
              ...
              error: (err) => {
                console.error(
                  ...oo_tx(
                    `3037710898_300_16_300_81_11`,
                    'Error al eliminar archivo de Azure Storage:',
                    err,
                  ),
                );
          ...
          error: (err) => {
            console.error(
              ...oo_tx(`3037710898_311_12_311_62_11`, 'Error al eliminar documento:', err),
            );
