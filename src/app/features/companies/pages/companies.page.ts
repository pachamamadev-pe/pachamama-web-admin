...
export class CompaniesPage implements OnInit {
  ...
  loadCompanies(): void {
    ...
    this.companiesService
      ...
      .subscribe({
        ...
        error: (error) => {
          console.error(...oo_tx(`356625275_140_10_140_58_11`, 'Error loading companies:', error));
  ...
  toggleStatus(company: Company): void {
    ...
    this.companiesService.updateCompany(company.id, { status: newStatus }).subscribe({
      ...
      error: (error) => {
        console.error(
          ...oo_tx(`356625275_284_8_284_62_11`, 'Error updating company status:', error),
        );
    ...
    dialogRef.afterClosed().subscribe((confirmed) => {
      if (confirmed) {
        this.companiesService.deleteCompany(company.id).subscribe({
          ...
          error: (error) => {
            console.error(...oo_tx(`356625275_309_12_309_59_11`, 'Error deleting company:', error));
