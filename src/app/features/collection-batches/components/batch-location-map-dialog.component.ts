...
export interface BatchLocationDialogData {
  batchNumber: string;
  location: {
    latitude: number;
    longitude: number;
...
@Component({
  selector: 'app-batch-location-map-dialog',
    ...
    <div class="location-dialog">
      ...
      <div class="dialog-header">
        <div class="dialog-title-group">
          ...
          <div>
            <h2 class="dialog-title">Punto de Acopio</h2>
            <p class="dialog-subtitle">{{ data.batchNumber }}</p>
          </div>
        </div>
...
export class BatchLocationMapDialogComponent {
  readonly data = inject<BatchLocationDialogData>(MAT_DIALOG_DATA);
  private dialogRef = inject(MatDialogRef<BatchLocationMapDialogComponent>);
