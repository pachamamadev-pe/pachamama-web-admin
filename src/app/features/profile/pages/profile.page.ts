...
export default class ProfilePage implements OnInit {
  ...
  private loadUserProfile(): void {
    ...
    this.usersService.getUserDetails(userId).subscribe({
      ...
      error: (error) => {
        console.error(...oo_tx(`132011669_123_8_123_55_11`, 'Error al cargar perfil:', error));
    ...
    this.usersService.updateUser(userId, formData).subscribe({
      next: () => {
        ...
        this.usersService.getUserDetails(userId).subscribe({
          ...
          error: (error) => {
            console.error(
              ...oo_tx(`132011669_224_12_224_61_11`, 'Error al recargar perfil:', error),
            );
            this.isSavingPersonalInfo.set(false);
          },
        });
      ...
      error: (error) => {
        console.error(
          ...oo_tx(`132011669_230_8_230_73_11`, 'Error al actualizar información personal:', error),
        );
  ...
  onImageUploaded(result: UploadResult): void {
    ...
    console.log(...oo_oo(`132011669_243_4_243_47_4`, 'Imagen subida, path:', result));
    ...
    this.usersService.updateAvatar(userId, result.relativePath).subscribe({
      next: () => {
        console.log(
          ...oo_oo(
            `132011669_251_8_251_74_4`,
            'Avatar actualizado en backend, recargando perfil...',
          ),
        );
        ...
        this.usersService.getUserDetails(userId).subscribe({
          ...
          error: (error) => {
            console.error(
              ...oo_tx(`132011669_261_12_261_61_11`, 'Error al recargar perfil:', error),
            );
          },
        });
      },
      error: (error) => {
        console.error(...oo_tx(`132011669_266_8_266_59_11`, 'Error al actualizar avatar:', error));
    ...
    this.usersService.updateAvatar(userId, null).subscribe({
      next: () => {
        ...
        this.usersService.getUserDetails(userId).subscribe({
          ...
          error: (error) => {
            console.error(
              ...oo_tx(`132011669_293_12_293_61_11`, 'Error al recargar perfil:', error),
            );
          },
        });
      },
      error: (error) => {
        console.error(...oo_tx(`132011669_298_8_298_57_11`, 'Error al eliminar avatar:', error));
  ...
  async changePassword(): Promise<void> {
    ...
    try {
      ...
      console.error(...oo_tx(`132011669_364_6_364_58_11`, 'Error al cambiar contraseña:', error));
      const errorMessage =
