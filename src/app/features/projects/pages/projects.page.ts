...
export class ProjectsPage implements OnInit {
  ...
  private loadProducts(): void {
    this.productsService.getProducts({ page: 0, size: 100 }).subscribe({
      ...
      error: (error) => {
        console.error(...oo_tx(`565958000_120_8_120_55_11`, 'Error loading products:', error));
        this.products.set([]);
      },
    });
  }
  ...
  loadProjects(): void {
    ...
    this.projectsService
      ...
      .subscribe({
        ...
        error: (error) => {
          console.error(...oo_tx(`565958000_144_10_144_57_11`, 'Error loading projects:', error));
  ...
  private createProjectWithCommunity(data: CreateProjectRequest, communityId: string): void {
    ...
    this.projectsService.createProject(data).subscribe({
        ...
        this.communityProjectLinkService
          ...
          .subscribe({
            ...
            error: (linkError) => {
              console.error(
                ...oo_tx(
                  `565958000_307_14_307_77_11`,
                  'Error linking project to community:',
                  linkError,
                ),
              );
      ...
      error: (error) => {
        console.error(...oo_tx(`565958000_317_8_317_55_11`, 'Error creating project:', error));
    ...
    this.projectsService.updateProject(id, data).subscribe({
      next: () => {
        ...
        this.communityProjectLinkService.updateLink(linkId, { communityId }).subscribe({
          ...
          error: (linkError) => {
            console.error(
              ...oo_tx(`565958000_347_12_347_70_11`, 'Error updating community link:', linkError),
            );
      ...
      error: (error) => {
        console.error(...oo_tx(`565958000_357_8_357_55_11`, 'Error updating project:', error));
  ...
  private updateProject(id: string, data: UpdateProjectRequest): void {
    this.projectsService.updateProject(id, data).subscribe({
      ...
      error: (error) => {
        console.error(...oo_tx(`565958000_370_8_370_55_11`, 'Error updating project:', error));
        this.notification.error('Error al actualizar proyecto');
      },
    });
  }
  ...
  private performDelete(id: string): void {
    this.projectsService.deleteProject(id).subscribe({
      ...
      error: (error) => {
        console.error(...oo_tx(`565958000_383_8_383_55_11`, 'Error deleting project:', error));
